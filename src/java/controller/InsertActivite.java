 ...
 * @author Family
 */
public class InsertActivite extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int id = act.insertActivite(connect,activite,prix);
//            response.getWriter().print(id);
            Vector<Employer> employers = new Employer().select(connect, "Employer");
            request.setAttribute("employer", employers);
            request.setAttribute("activite", id);
            RequestDispatcher dispatcher = request.getRequestDispatcher("activite_employer.jsp");
