    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Ajout Employer</h5>

              <!-- General Form Elements -->
              <form method="post" action="AjoutEmployer">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Employer :</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Date d'Embauche :</label>
                  <div class="col-sm-10">
